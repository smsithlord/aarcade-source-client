...
unsigned ThreadedFileBrowse(void *params)
{
	...
	ofn.lpstrFilter = "All\0*.*\0Images\0*.BMP;*.ICO;*.GIF;*.JPG;*.JPEG;*.JPE;*.JP2;*.PCX;*.PIC;*.PNG;*.PIX;*.RAW;*.TGA;*.TIF;*.VTF;*.TBN\0Videos\0*.MPG;*.MPEG;*.AVI;*.MKV;*.MP4;*.MPG;*.MPEG;*.FLV;*.BIN;*.ISO;*.VOB\0Executables\0*.EXE\0Steam/Internet Shortcuts\0*.URL\0Other Custom Shortcuts\0*.LNK\0\0";
	ofn.nFilterIndex = 1;
