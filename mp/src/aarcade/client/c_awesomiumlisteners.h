...
class DialogListener : public WebViewListener::Dialog
{
	void OnShowFileChooser(WebView *caller, const Awesomium::WebFileChooserInfo &chooser_info);
	void OnShowLoginDialog(WebView *caller, const Awesomium::WebLoginDialogInfo &dialog_info) {};
	void OnShowCertificateErrorDialog(WebView *caller, bool is_overridable, const WebURL &url, CertError error) {};
	void OnShowPageInfoDialog(WebView *caller, const WebPageInfo &page_info) {};
};
