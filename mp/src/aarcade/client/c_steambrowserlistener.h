...
private:
	STEAM_CALLBACK(C_SteamBrowserListener, NewLaunchQueryParameters, NewLaunchQueryParameters_t, m_NewLaunchQueryParameters);
	STEAM_CALLBACK(C_SteamBrowserListener, RichPresenceJoinRequested, GameRichPresenceJoinRequested_t, m_RichPresenceJoinRequested);
