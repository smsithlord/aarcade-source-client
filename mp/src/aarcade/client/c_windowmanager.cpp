...
// This define is because exposing the input slate broke the definition for GetClassName here.
#ifdef UNICODE
#define AAGetClassName  GetClassNameW
#else
#define AAGetClassName  GetClassNameA
#endif // !UNICODE
...
BOOL CALLBACK C_WindowManager::EnumWindowsProc(HWND hwnd, LPARAM lParam)
{
	...
	AAGetClassName(hwnd, class_name, sizeof(class_name));	
